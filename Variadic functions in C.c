/*Varaible argument functions in C - ellipsis in function signature for variable number of args
  include stdarg.h to get the 3 macros va_list, va_start, va_arg
  va_list ptr - to create a ptr of the type va_list
  va_start(ptr,count) - to set the pointer to the beginning of the first argument of the list of variable arguments
  va_arg(ptr, int) - to consume the int arg pointed to by the pointer currently and then move ptr to next arg
*/
